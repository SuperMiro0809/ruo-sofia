...
const ProtocolsMpsModal = ({ openProp, selectedProtocolProp, getProtocols }) => {
    const navigate = useNavigate();
    const messageContext = useContext(MessageContext);

    const deleteCustomer = () => {
        protocolMpsServices.destroy(selectedProtocolProp.selectedProtocol)
        .then(data => {
          getProtocols();
          closeModal();
...
export default ProtocolsMpsModal;