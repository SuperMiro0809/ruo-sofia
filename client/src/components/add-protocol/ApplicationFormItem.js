                                        ...
                                        <FieldArray
                                            ...
                                            render={tArrayHelpers => (
                                                <ApplicationsApplyItem
                                                    key={tIndex}
                                                    mode="teachings"
                                                    type={`Обучение на тема ${teaching.theme}, проведено от ${teaching.institution} от ${moment(teaching.startDate).format('DD.MM.YYYY')} до ${moment(teaching.endDate).format('DD.MМ.YYYY')} г. за ${teaching.lessonHours} ак. часа`}
                                                    props={{
                                                        el: teaching,
                                        ...
                                        <FieldArray
                                            ...
                                            render={rArrayHelpers => (
                                                <ApplicationsApplyItem
                                                    key={rIndex}
                                                    mode="reports"
                                                    type={`Доклад, научно съобщение или преззентация на тема ${report.theme}, проведено от ${report.institution} от ${moment(report.startDate).format('DD.MM.YYYY')} до ${moment(report.endDate).format('DD.MМ.YYYY')} г. за ${report.lessonHours} ак. часа`}
                                                    props={{
                                                        el: report,
                                        ...
                                        <FieldArray
                                            ...
                                            render={pArrayHelpers => (
                                                <ApplicationsApplyItem
                                                    key={pIndex}
                                                    mode="publications"
                                                    type={`Публикация на тема ${publication.theme}, проведена от ${publication.institution} от ${moment(publication.startDate).format('DD.MM.YYYY')} до ${moment(publication.endDate).format('DD.MМ.YYYY')} г., публикувана на ${publication.published}`}
                                                    props={{
                                                        el: publication,
