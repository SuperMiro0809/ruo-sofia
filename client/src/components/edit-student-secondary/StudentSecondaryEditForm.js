...
const StudentSecondaryEditForm = ({student, ...rest }) => {
    ...
    const [documentDate, setDocumentDate] = useState(student.documentDate);
                    ...
                    <Container maxWidth="1050">
                        <Formik
                            initialValues={{
                                ...
                                documentDate: student.documentDate,
                                school: student.school,
                                cityAndCountry: student.cityAndCountry,
...
export default StudentSecondaryEditForm;
