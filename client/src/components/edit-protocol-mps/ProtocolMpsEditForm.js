...
const ProtocolMpsEditForm = ({ protocol, ...rest }) => {
                    ...
                    <Container maxWidth="1050">
                        <Formik
                            initialValues={{
                                ...
                                vicePresidents: protocol.vicePresidents,
                            ...
                            onSubmit={(values, { setSubmitting }) => {
                                protocolMpsServices.edit(protocol.id, values)
                                    .then(r => {
...
export default ProtocolMpsEditForm;